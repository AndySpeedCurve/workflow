  ...
  return (
    <div className={styles.container}>
      ...
      <main>
        ...
        <p>This site performs a jest check on the functions using a github action. If all actions in github pass then it triggers a build using a netlify webhook. Lets see what happens as I push a PR.</p>
